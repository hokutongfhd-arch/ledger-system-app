            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input
                        ...
                        required
                        disabled={isSelfEdit} // Usually code is not changeable by self
                    />
                </div>
                <div>
                ...
                {/* Company No and Email fields removed per request */}
                ...
                <div>
                    ...
                    <select
                        ...
                        disabled={!isAdmin} // Self-edit cannot change role
                    >
