...
export const employeeApi = {
    fetchEmployees: async () => {
        return await supabase.from('employees').select('id, employee_code, name, name_kana, gender, birthday, join_date, age_at_month_end, years_in_service, months_in_service, area_code, address_code, authority, auth_id, email');
    },
