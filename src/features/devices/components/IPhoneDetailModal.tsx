            ...
            <div className="space-y-6 font-sans">
                ...
                {showHistory ? (
                    ...
                    <div className="space-y-8 font-sans">
                        ...
                        <div>
                            <SectionHeader icon={<Smartphone size={18} />} title="基本情報" />
                            <div className="bg-gray-50/50 p-5 rounded-xl border border-gray-100 space-y-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <DetailRow label="管理番号" value={item.managementNumber} icon={<Smartphone size={14} className="text-gray-400" />} />
                                    <DetailRow label="電話番号" value={formatPhoneNumber(item.phoneNumber)} icon={<Phone size={14} className="text-gray-400" />} />
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        {/* Section 2: User Info (Includes Dates as per Form) */}
                        <div>
                        ...
                        <div>
                            ...
                            <div className="bg-gray-50/50 p-5 rounded-xl border border-gray-100 space-y-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <DetailRow label="SMARTアドレス帳PW" value={item.smartAddressPw || ''} />
                                </div>
                                <div className="group border-t border-gray-200 pt-4 mt-2">
